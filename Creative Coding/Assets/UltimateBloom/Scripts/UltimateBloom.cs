...
public class UltimateBloom : MonoBehaviour
{
    ...
    public Color m_FlareTint0 = new Color(78 / 255.0f, 69 / 255.0f, 149.0f / 255.0f);
    public Color m_FlareTint1 = new Color(36 / 255.0f, 51 / 255.0f, 141 / 255.0f);
    public Color m_FlareTint2 = new Color(29 / 255.0f, 41 / 255.0f, 105 / 255.0f);
    public Color m_FlareTint3 = new Color(17 / 255.0f, 22 / 255.0f, 107 / 255.0f);
    public Color m_FlareTint4 = new Color(78 / 255.0f, 69 / 255.0f, 149.0f / 255.0f);
    public Color m_FlareTint5 = new Color(36 / 255.0f, 51 / 255.0f, 141 / 255.0f);
    public Color m_FlareTint6 = new Color(29 / 255.0f, 41 / 255.0f, 105 / 255.0f);
    public Color m_FlareTint7 = new Color(17 / 255.0f, 22 / 255.0f, 107 / 255.0f);
    public Vector4 m_FlareScales = new Vector4(55.77f, 2.5f, 1.32f, 1.12f);
    public Vector4 m_FlareScalesNear = new Vector4(12, 7.37f, 5.3f, 4.14f);
    public Texture2D m_FlareMask;
    public FlareRendering m_FlareRendering = FlareRendering.Sharp;
